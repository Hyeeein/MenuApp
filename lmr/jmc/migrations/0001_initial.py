# Generated by Django 3.2.16 on 2023-04-04 07:59
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('egg', models.IntegerField(blank=True, default=0, null=True)),
                ('milk', models.IntegerField(blank=True, default=0, null=True)),
                ('wheat', models.IntegerField(blank=True, default=0, null=True)),
                ('bean', models.IntegerField(blank=True, default=0, null=True)),
                ('peanut', models.IntegerField(blank=True, default=0, null=True)),
                ('fish', models.IntegerField(blank=True, default=0, null=True)),
                ('meat', models.IntegerField(blank=True, default=0, null=True)),
                ('shellfish', models.IntegerField(blank=True, default=0, null=True)),
                ('crustaceans', models.IntegerField(blank=True, default=0, null=True)),
